...
var ASM_CONSTS = {
  109984: () => { if (document.fullscreenElement) return 1; },  
 110030: () => { return document.getElementById('canvas').width; },  
 110082: () => { return parseInt(document.getElementById('canvas').style.width); },  
 110150: () => { document.exitFullscreen(); },  
 110177: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 110250: () => { if (document.fullscreenElement) return 1; },  
 110296: () => { return document.getElementById('canvas').width; },  
 110348: () => { return screen.width; },  
 110373: () => { document.exitFullscreen(); },  
 110400: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 110533: () => { return window.innerWidth; },  
 110559: () => { return window.innerHeight; },  
 110586: () => { if (document.fullscreenElement) return 1; },  
 110632: () => { return document.getElementById('canvas').width; },  
 110684: () => { return parseInt(document.getElementById('canvas').style.width); },  
 110752: () => { if (document.fullscreenElement) return 1; },  
 110798: () => { return document.getElementById('canvas').width; },  
 110850: () => { return screen.width; },  
 110875: () => { return window.innerWidth; },  
 110901: () => { return window.innerHeight; },  
 110928: () => { if (document.fullscreenElement) return 1; },  
 110974: () => { return document.getElementById('canvas').width; },  
 111026: () => { return screen.width; },  
 111051: () => { document.exitFullscreen(); },  
 111078: () => { if (document.fullscreenElement) return 1; },  
 111124: () => { return document.getElementById('canvas').width; },  
 111176: () => { return parseInt(document.getElementById('canvas').style.width); },  
 111244: () => { document.exitFullscreen(); },  
 111271: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 111329: () => { return screen.width; },  
 111354: () => { return screen.height; },  
 111380: () => { return window.screenX; },  
 111407: () => { return window.screenY; },  
 111434: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 111487: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 111558: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 111615: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 111871: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 111942: () => { if (document.fullscreenElement) return 1; },  
 111988: () => { return window.innerWidth; },  
 112014: () => { return window.innerHeight; },  
 112041: () => { if (document.pointerLockElement) return 1; }
};
