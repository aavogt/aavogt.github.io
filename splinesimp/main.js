...
var ASM_CONSTS = {
  110256: () => { if (document.fullscreenElement) return 1; },  
 110302: () => { return document.getElementById('canvas').width; },  
 110354: () => { return parseInt(document.getElementById('canvas').style.width); },  
 110422: () => { document.exitFullscreen(); },  
 110449: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 110522: () => { if (document.fullscreenElement) return 1; },  
 110568: () => { return document.getElementById('canvas').width; },  
 110620: () => { return screen.width; },  
 110645: () => { document.exitFullscreen(); },  
 110672: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 110805: () => { return window.innerWidth; },  
 110831: () => { return window.innerHeight; },  
 110858: () => { if (document.fullscreenElement) return 1; },  
 110904: () => { return document.getElementById('canvas').width; },  
 110956: () => { return parseInt(document.getElementById('canvas').style.width); },  
 111024: () => { if (document.fullscreenElement) return 1; },  
 111070: () => { return document.getElementById('canvas').width; },  
 111122: () => { return screen.width; },  
 111147: () => { return window.innerWidth; },  
 111173: () => { return window.innerHeight; },  
 111200: () => { if (document.fullscreenElement) return 1; },  
 111246: () => { return document.getElementById('canvas').width; },  
 111298: () => { return screen.width; },  
 111323: () => { document.exitFullscreen(); },  
 111350: () => { if (document.fullscreenElement) return 1; },  
 111396: () => { return document.getElementById('canvas').width; },  
 111448: () => { return parseInt(document.getElementById('canvas').style.width); },  
 111516: () => { document.exitFullscreen(); },  
 111543: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 111601: () => { return screen.width; },  
 111626: () => { return screen.height; },  
 111652: () => { return window.screenX; },  
 111679: () => { return window.screenY; },  
 111706: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 111759: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 111830: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 111887: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 112143: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 112214: () => { if (document.fullscreenElement) return 1; },  
 112260: () => { return window.innerWidth; },  
 112286: () => { return window.innerHeight; },  
 112313: () => { if (document.pointerLockElement) return 1; }
};
