...
var ASM_CONSTS = {
 ...
 111550: () => { return document.getElementById('canvas').width; },  
 111602: () => { return parseInt(document.getElementById('canvas').style.width); },  
 111670: () => { document.exitFullscreen(); },  
 111697: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 111770: () => { if (document.fullscreenElement) return 1; },  
 111816: () => { return document.getElementById('canvas').width; },  
 111868: () => { return screen.width; },  
 111893: () => { document.exitFullscreen(); },  
 111920: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 112053: () => { return window.innerWidth; },  
 112079: () => { return window.innerHeight; },  
 112106: () => { if (document.fullscreenElement) return 1; },  
 112152: () => { return document.getElementById('canvas').width; },  
 112204: () => { return parseInt(document.getElementById('canvas').style.width); },  
 112272: () => { if (document.fullscreenElement) return 1; },  
 112318: () => { return document.getElementById('canvas').width; },  
 112370: () => { return screen.width; },  
 112395: () => { return window.innerWidth; },  
 112421: () => { return window.innerHeight; },  
 112448: () => { if (document.fullscreenElement) return 1; },  
 112494: () => { return document.getElementById('canvas').width; },  
 112546: () => { return screen.width; },  
 112571: () => { document.exitFullscreen(); },  
 112598: () => { if (document.fullscreenElement) return 1; },  
 112644: () => { return document.getElementById('canvas').width; },  
 112696: () => { return parseInt(document.getElementById('canvas').style.width); },  
 112764: () => { document.exitFullscreen(); },  
 112791: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 112849: () => { return screen.width; },  
 112874: () => { return screen.height; },  
 112900: () => { return window.screenX; },  
 112927: () => { return window.screenY; },  
 112954: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 113007: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 113078: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 113135: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 113391: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 113462: () => { if (document.fullscreenElement) return 1; },  
 113508: () => { return window.innerWidth; },  
 113534: () => { return window.innerHeight; },  
 113561: () => { if (document.pointerLockElement) return 1; }
};
