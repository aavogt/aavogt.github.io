...
var ASM_CONSTS = {
  111504: () => { return window.matchMedia("(pointer: coarse)").matches ? 1 : 0; },  
 111571: () => { if (document.fullscreenElement) return 1; },  
 111617: () => { return document.getElementById('canvas').width; },  
 111669: () => { return parseInt(document.getElementById('canvas').style.width); },  
 111737: () => { document.exitFullscreen(); },  
 111764: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 111837: () => { if (document.fullscreenElement) return 1; },  
 111883: () => { return document.getElementById('canvas').width; },  
 111935: () => { return screen.width; },  
 111960: () => { document.exitFullscreen(); },  
 111987: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 112120: () => { return window.innerWidth; },  
 112146: () => { return window.innerHeight; },  
 112173: () => { if (document.fullscreenElement) return 1; },  
 112219: () => { return document.getElementById('canvas').width; },  
 112271: () => { return parseInt(document.getElementById('canvas').style.width); },  
 112339: () => { if (document.fullscreenElement) return 1; },  
 112385: () => { return document.getElementById('canvas').width; },  
 112437: () => { return screen.width; },  
 112462: () => { return window.innerWidth; },  
 112488: () => { return window.innerHeight; },  
 112515: () => { if (document.fullscreenElement) return 1; },  
 112561: () => { return document.getElementById('canvas').width; },  
 112613: () => { return screen.width; },  
 112638: () => { document.exitFullscreen(); },  
 112665: () => { if (document.fullscreenElement) return 1; },  
 112711: () => { return document.getElementById('canvas').width; },  
 112763: () => { return parseInt(document.getElementById('canvas').style.width); },  
 112831: () => { document.exitFullscreen(); },  
 112858: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 112916: () => { return screen.width; },  
 112941: () => { return screen.height; },  
 112967: () => { return window.screenX; },  
 112994: () => { return window.screenY; },  
 113021: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 113074: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 113145: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 113202: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 113458: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 113529: () => { if (document.fullscreenElement) return 1; },  
 113575: () => { return window.innerWidth; },  
 113601: () => { return window.innerHeight; },  
 113628: () => { if (document.pointerLockElement) return 1; }
};
