...
var ASM_CONSTS = {
 ...
 92979: () => { return parseInt(Module.canvas.style.width); },  
 93027: () => { document.exitFullscreen(); },  
 93054: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 93126: () => { if (document.fullscreenElement) return 1; },  
 93172: () => { return Module.canvas.width; },  
 93204: () => { return screen.width; },  
 93229: () => { document.exitFullscreen(); },  
 93256: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93389: () => { return window.innerWidth; },  
 93415: () => { return window.innerHeight; },  
 ...
 93568: () => { if (document.fullscreenElement) return 1; },  
 93614: () => { return Module.canvas.width; },  
 93646: () => { return screen.width; },  
 93671: () => { return window.innerWidth; },  
 93697: () => { return window.innerHeight; },  
 93724: () => { if (document.fullscreenElement) return 1; },  
 93770: () => { return Module.canvas.width; },  
 93802: () => { return screen.width; },  
 93827: () => { document.exitFullscreen(); },  
 93854: () => { if (document.fullscreenElement) return 1; },  
 93900: () => { return Module.canvas.width; },  
 93932: () => { return parseInt(Module.canvas.style.width); },  
 93980: () => { document.exitFullscreen(); },  
 94007: ($0) => { Module.canvas.style.opacity = $0; },  
 94045: () => { return screen.width; },  
 94070: () => { return screen.height; },  
 94096: () => { return window.screenX; },  
 94123: () => { return window.screenY; },  
 94150: () => { return window.devicePixelRatio; },  
 94186: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94239: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94290: () => { Module.canvas.style.cursor = 'none'; },  
 94327: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94583: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94634: () => { if (document.pointerLockElement) return 1; },  
 94681: () => { if (document.fullscreenElement) return 1; },  
 94727: () => { return window.innerWidth; },  
 94753: () => { return window.innerHeight; }
};
